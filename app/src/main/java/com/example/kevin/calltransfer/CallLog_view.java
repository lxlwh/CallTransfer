...
public class CallLog_view extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(CallLog_view.this, Manifest.permission.READ_CALL_LOG) != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(CallLog_view.this,new String[]{Manifest.permission.READ_CALL_LOG},1);
        }else {
